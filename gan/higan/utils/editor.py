...
def mix_style(style_codes,
  ...
  styles by partically replacing the codes of `content_codes` from some certain
...
def manipulate(latent_codes,
  ...
  *code_shape], and `boundary` to be with shape [1, *code_shape] and unit norm.
  ...
  with even better performance, to only partically manipulate these latent codes
