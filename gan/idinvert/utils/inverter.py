...
from gan.idinvert.models.stylegan_generator import StyleGANGenerator
from gan.idinvert.models.stylegan_encoder import StyleGANEncoder
from gan.idinvert.models.perceptual_model import PerceptualModel
...
class StyleGANInverter(object):
  ...
  def invert(self, image, num_viz=1):
